package com.reversecoder.residemenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        inflater.inflate(R.layout.residemenu_custom_with_header, this);
        ...
        llHeader = (LinearLayout) findViewById(R.id.ll_header_info);
        tvHeaderTitle = (TextView) findViewById(R.id.tv_header_title);
        tvHeaderSubtitle = (TextView) findViewById(R.id.tv_header_subtitle);
    ...
    public void setHeaderSubtitle(String headerSubtitle) {
        tvHeaderSubtitle.setText(headerSubtitle);
    }
}
